...
var initialColors = colorbrewer.YlGn[8];
...
var attNames = ["HydroElect", "Wood", "Ethanol", "NuclearEle","GeoThermal","Solar","Wind"];
...
d3.json("data/cleanEner.json", function(error, jsonData) {
  ...
  function highlight(data){
    ...
    var labelAttribute = "<h2>"+ roundRight(props[expressed])+"</h2>Trillion Btu"+ expressed +"</b>:" + props[key]; //label content
  ...
  function moveLabel() {
    var x = d3.event.clientX-5; //horizontal label coordinate based mouse position stored in d3.event
